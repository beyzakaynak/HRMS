...
public class BRPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BRPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BRPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BRPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BRPDateTimeConverter dateTimeConverter = new BRPStandardDateTimeConverter();

    public BRPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BRPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BRPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BRPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BRPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BRPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
