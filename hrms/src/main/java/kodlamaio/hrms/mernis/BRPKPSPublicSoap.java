...
public class BRPKPSPublicSoap
{
    ...
    public BRPKPSPublicSoap(){}

    public BRPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BRPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BRPExtendedSoapSerializationEnvelope envelope= new BRPExtendedSoapSerializationEnvelope(BRPExtendedSoapSerializationEnvelope.VER11);
